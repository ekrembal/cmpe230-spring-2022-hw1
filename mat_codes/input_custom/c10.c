...
Variable *_r = createScalar();
Variable *_A = createMatrix(20, 20);
Variable *_fzxc0WG0lVAj6AT = generateScalarFromNumber(10);
assign(_b, _fzxc0WG0lVAj6AT);
Variable *_LoGBufBRBHNmNqf = generateScalarFromNumber(2);
Variable *_jjX2A9VNFsfJ4qH = multiplication(_b, _LoGBufBRBHNmNqf);
assign(_a, _jjX2A9VNFsfJ4qH);
Variable *_XqfK9Nxwuggw4mF = generateScalarFromNumber(6);
assign(_r, _XqfK9Nxwuggw4mF);
...
for(assign(_i,_gqHSf71iezcBdjb); isLower(_i,_a); increase(_i,_EHKvrLK5t5pJqPy)){
for(assign(_j,_ehHGCc0Fy6fV74l); isLower(_j,_a); increase(_j,_olx4OhLjzJCaRYs)){
Variable *_gZQKLSjEy4CZwcD = substraction(_i, _b);
Variable *_VRab5y965CSUrp2 = substraction(_i, _b);
Variable *_649VOR3g7qLY34A = multiplication(_gZQKLSjEy4CZwcD, _VRab5y965CSUrp2);
Variable *_AQWygqUNk06ONHx = substraction(_j, _b);
Variable *_BBKNLvwJByKkPJn = substraction(_j, _b);
Variable *_kGR7Q0B0MwbPNRB = multiplication(_AQWygqUNk06ONHx, _BBKNLvwJByKkPJn);
Variable *_7BJI6dqpRz1glsX = addition(_kGR7Q0B0MwbPNRB, _649VOR3g7qLY34A);
Variable *_JsDClAyQ67Rr71R = squareroot( _7BJI6dqpRz1glsX );
Variable *_83pEVYSS5RyWOLZ = substraction(_JsDClAyQ67Rr71R, _r);
Variable *_BfIewjUiks8qojm = generateScalarFromNumber(1);
Variable *_Z4HUXbH5Xp338Xs = generateScalarFromNumber(1);
Variable *_bwQ4YUInOGVfXYO = generateScalarFromNumber(8);
Variable *_LVXDSZ7h6HJk0tJ = choose( _83pEVYSS5RyWOLZ, _BfIewjUiks8qojm, _Z4HUXbH5Xp338Xs, _bwQ4YUInOGVfXYO );
assignToDoubleIndex(_A, _i, _j, _LVXDSZ7h6HJk0tJ);
}}
print(_A);
return 0;
}
